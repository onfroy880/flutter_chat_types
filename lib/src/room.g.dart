...
Room _$RoomFromJson(Map<String, dynamic> json) => Room(
      ...
      lastMessages: (json['lastMessages'] as List<dynamic>?)?.map((e) => Message.fromJson(e as Map<String, dynamic>)).toList(),
...
Map<String, dynamic> _$RoomToJson(Room instance) {
  ...
  writeNotNull('lastMessages', instance.lastMessages?.map((e) => e.toJson()).toList());
  writeNotNull('metadata', instance.metadata);
  writeNotNull('name', instance.name);
  writeNotNull('type', _$RoomTypeEnumMap[instance.type]);
  writeNotNull('updatedAt', instance.updatedAt);
  val['users'] = instance.users.map((e) => e.toJson()).toList();
  writeNotNull('unread_message', instance.unreadMessage);
  return val;
}
