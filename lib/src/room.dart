...
abstract class Room extends Equatable {
  ...
  const Room._({
    ...
    this.updatedAt,
    required this.users,
    this.unreadMessage, // Add unreadMessage here
  });
  ...
  const factory Room({
    ...
    int? unreadMessage, // Add unreadMessage here
  }) = _Room;
  ...
  /// Unread message count for the room.
  final int? unreadMessage; // Add unreadMessage here
  ...
  List<Object?> get props => [
        ...
        updatedAt,
        users,
        unreadMessage, // Add unreadMessage here
      ];

  /// Creates a copy of the room with an updated data.
  /// [imageUrl], [name], [updatedAt], and [unreadMessage] with null values will nullify existing values
...
class _Room extends Room {
  const _Room({
    ...
    super.unreadMessage, // Add unreadMessage here
  }) : super._();
  ...
  Room copyWith({
    ...
    List<User>? users,
    dynamic unreadMessage = _Unset, // Add unreadMessage here
  }) =>
      _Room(
        ...
        unreadMessage: unreadMessage == _Unset ? this.unreadMessage : unreadMessage as int?, // Handle unreadMessage here
      );
}
